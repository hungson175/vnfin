...
- **#226 — DESIGN_BLOCK (2026-08-24, corrected exact-SHA design re-review).** Actor
  ...
  Reviewed merged HEAD `2666c6dfe816091c31fb19e52ade29675f9a35f6`, prior correction content anchor
  `41b52e6cac04a2c1304756022b29ad8a8961f5a6`, and clean range `001cfd1..2666c6d`. BLOCK delivery
  `#b378c629`; report `reviews/review-202608241141-issue226-corrected-design-rereview.md` at
  reviewer `e8f1396`. R1-R3 require rights-slot separation/absence wording, API/model versus RED
  separation, fail-before-cache and explicit API/units docs gates, plus ordered section headings.
  Preserve `SOURCE-GAP CLOSURE`, the empty chain, #202 separation, #227 queue, and no probe, RED,
  code, push, or close; apply one narrow docs/backlog-only correction.
