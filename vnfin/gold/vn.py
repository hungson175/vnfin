...
#
# This is BTMC's own client-side widget key (the fixed value its public price-ticker
# widget sends from the browser); it carries no login/account and is not a user
# secret. It is committed here as a single plain literal (no fragment/concatenation
# trickery): the secret-scanner allowlists this exact value by explicit policy while
# still failing on any other key/JWT.
BTMC_PUBLIC_WIDGET_KEY = "3kd8ub1llcg9t45hnoh8hmn7t5kc2v"
